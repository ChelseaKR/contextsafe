...
| Security & Supply-Chain | Applies — Semgrep SAST, gitleaks secret scan, pip-audit dependency audit (`.github/workflows/security.yml` + `make audit`), pinned `uv.lock`, SHA-pinned actions, `SECURITY.md` |
